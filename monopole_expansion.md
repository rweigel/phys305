...
When both the charge and point of interest are at arbitrary locations in space, the angle between $\mathbf{r}$ and $\mathbf{r}'$ is no longer the spherical polar angle, $\theta$. In this case, the angle $\alpha$ between $\mathbf{r}$ and $\mathbf{r}'$ will in general depend on both $\theta$ and $\phi$. From the definition of the dot product, $\cos\alpha$ is given by
...
## Example -- Point Charge on $+z$ axis
...
## Problem -- Point Charge on $x$--axis
...
## Problem -- Point charge in $x$--$y$ plane
...
%$\mathbf{r}'=b\xhat+b\yhat$ so $r'=\sqrt{2}b$


%$\displaystyle V=\frac{kq}{r}\left[P_0(\cos\alpha) + \frac{\sqrt{2}b}{r}P_1(\cos\alpha)\right]=\frac{kq}{r}\left(1+\frac{\sqrt{2}b}{r}\cos\alpha\right)$

%$\displaystyle\cos\alpha=\frac{\mathbf{r}\bfcdot\mathbf{r}'}{rr'}=\frac{xb+yb}{\sqrt{2}br}=\frac{1}{\sqrt{2}}\frac{x+y}{r}$

%Using $x=r\sin\theta\cos\phi$ and $y=r\sin\theta\sin\phi$ gives

%$\displaystyle\cos\alpha = \frac{1}{\sqrt{2}}(\sin\theta\cos\phi+\sin\theta\sin\phi)$

%and

%$\displaystyle V(r, \theta, \phi) = \frac{kq}{r}\left(1+\frac{b}{r}(\sin\theta\cos\phi+\sin\theta\sin\phi)\right)$

%2.

%$\displaystyle E_r=-\frac{\partial V}{\partial r}$

%$\displaystyle E_r=\frac{kq}{r^2}\left(1+\frac{2b}{r}(\sin\theta\cos\phi+\sin\theta\sin\phi)\right)$

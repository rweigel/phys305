...
1. All of what I would normally lecture on has been written into the tutorial and its examples.
...
*Put at top of first few tutorials*

Instead of being graded on a weekly homework assignment, you will be graded on a "Homework Assessment". Based on past experience, your average Homework Assessment grade will be very close to your grade if I had graded all of your homework problems. Due to the size of this course, grading all homeworks is not possible. However, if you have a question about any homework problem before or after the Homework Assessment it complete, I will discuss it with you any day of the week. Just send me a note on Discord.

Logistics:

1. The homework assessments are 30-minutes and must be worked on during class.
2. You will turn your work in by creating a PDF with your smartphone.

Content:
 
1. part of a problem that appeared on the tutorial,
2. part of an example problem that appeared on the tutorial, or
3. a problem that is very similar to a tutorial or example problem.
    
I will not provide solutions to all of the problems on the tutorials prior to the homework assessment. I will however, provided detailed solutions after you complete your weekly homework assessment.

**Weekly schedule**

1. On Thursday evening, a new tutorial is distributed.
2. On Tuesday for the entire class period and Thursday for the first 45 minutes, I will answer questions in class.
   * I will not work through problems on the tutorial. These problems should be considered as equivalent to homework problems, and as such, I will only provide hints and discussion of related problems.
3. During the last 30 minutes of class on Thursday, you will take the Homework Assessment. 
...
[https://catalog.gmu.edu/search/?search=PHYS+305 Physics 305] - Electromagnetic Theory

Interaction of static charges, interaction of stationary currents, electromagnetic induction, and Maxwell's equations.

Required Prerequisites: PHYS 260<sup>C</sup> and PHYS 301<sup>*C</sup>.
...
2. Your exam average (70%) - two exams during the semester and one final exam, equally weighted.
...
1. Electrostatics (Coulomb's Law, Integral Gauss' Law, Potentials)
2. Special techniques for calculating potentials
3. Electrostatic fields in matter

Exam 2 will cover

1. Magnetostatics (Biot-Savart, Gauss' Law for Magnetism, and Integral Ampere's Law)
2. Magnetostatic fields in matter
3. Electrodynamics (Full Maxwell Equations)

The final exam will cover
* All topics (Chapters 1-7 of Griffiths)

Nominally, your course grade is a straightforward weighted average of your homework and exam averages.  However, if

1. your exam average is greater than your homework average, your exam average determines your final grade;
2. your final exam average is greater than the average of exam 1 and exam 2, your final exam score determines your final grade.

The nominal percentage-to-letter grade conversion is (this is subject to change so that the required percentage score for a given letter grade is lower)
...
I will follow the outline of the topics covered in chapters 1-7 in [https://www.amazon.com/Introduction-Electrodynamics-4th-David-Griffiths/dp/0321856562 4th edition of Introduction to Electrodynamics (4th Edition) by David J. Griffiths].  Note that [https://www.amazon.com/Introduction-Electrodynamics-3rd-David-Griffiths/dp/013805326X Introduction to Electrodynamics (3rd Edition) by David J. Griffiths, 1999] is also widely available.  You may buy either edition.  However, I will reference pages and problem numbers from 4th edition.
...
[https://www.amazon.com/Electricity-Magnetism-Edward-M-Purcell/dp/1107014026/ Electricity and Magnetism (3rd Edition) by Edward M. Purcell and David J. Morin] covers the same topics as Griffiths at the same level.  If you are looking for an alternative explanation, this textbook will be helpful.  The book contains far more examples, discussion, and content than Griffiths.  It also includes solutions.  

[http://www.amazon.com/Schaums-Outline-Electromagnetics-4th-Outlines/dp/0071831479/ Schaum's outline of theory and problems of electromagnetics by Joseph A. Edminister] is a great reference for problems with full solutions and summaries of topics.

[https://www.amazon.com/Div-Grad-Curl-All-That/dp/0393925161/ Div, Grad, Curl, and All That: An Informal Text on Vector Calculus (4th Edition) by H. M. Schey] is an excellent reference for the mathematical background that you need to understand for this course.  The book contains a concise and clear review of topics that are covered in a vector calculus course (usually "Calculus III").

[https://www.amazon.com/Students-Guide-Maxwells-Equations/dp/0521701473/ A Student's Guide to Maxwell's Equations (1st Edition) by Daniel Fleisch] notes that "the focus is exclusively on Maxwell’s Equations, which means you won’t have to wade through hundreds of pages of related topics to get to the essential concepts. This leaves room for in-depth explanations of the most relevant features, such as the difference between charge-based and induced electric fields, the physical meaning of divergence and curl, and the usefulness of both the integral and differential forms of each equation." A web page with detailed solutions to problems is available at http://www.danfleisch.com/maxwell/.

[https://www.amazon.com/Feynman-Lectures-Physics-Mainly-Electromagnetism/dp/020102117X/ The Feynman Lectures on Physics: Mainly Electromagnetism and Matter, Volume 2, 1977] contains excellent lecture-style presentations on Electricity and Magnetism.  The full volume is available online at [http://www.feynmanlectures.caltech.edu/II_toc.html]

[http://freevideolectures.com/Course/2340/Electromagnetic-Fields IIT Madras Course ELECTROMAGNETIC FIELDS] is the only free video lecture series that I know of that covers E&M at the level of this course.

[https://www.youtube.com/playlist?list=PLD07B2225BB40E582&feature=plcp Yale Lectures on Physics II] is a lecture series on topics typically covered in a second-semester physics course and does not cover the mathematics at the level required for this course.  These videos may be useful as a review.

[http://web.mit.edu/viz/soft/visualizations/IntermediateE&M/classNotes_2010_final.pdf 8.07 Class Notes by John Belcher] covers the same topics as Griffiths and has additional examples.
...
[Important Dates](https://registrar.gmu.edu/calendars/fall_2021/#dates)
